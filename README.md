...
`출발지 중심` 주변을 `500m x 500m` 격자로 나누고, 각 격자에서 `목적지`까지의 소요 시간을 히트맵으로 표시하는 웹앱입니다.
...
- 반경을 고정 20km로 설정해서 한 화면 격자 수를 제어

관련 환경변수:

- `MAX_TRANSIT_SAMPLES` (기본 30)
- `MIN_RADIUS_METERS` (기본 20000)
- `MAX_RADIUS_METERS` (기본 20000)
